...
public class RundvisningWindow extends Stage {
	...
	private List<Rundvisning> initAllRundvisninger() {
	...
	/*
	 * Aabner for "OpretRundvisningWindow"
	 */
	...
	/*
	 * Sletter den rundvisning man har klikket på i listviewet, Hvorefter den tager
	 * alle objekter fra InitAllProdukter og tilføjer dem til Rundvisning Listviewet
	 */
	private void btnSletAction() {
		Rundvisning r = lwRundvisning.getSelectionModel().getSelectedItem();
		service.sletRundvisning(r);
		lwRundvisning.getItems().setAll(initAllRundvisninger());
	...
	/*
	 * Opdater textfields, hvis nyt er skrevet
	 */
	...
	/*
	 * Sætter textfield Antal spisende til editable, hvis checkboxen er udfyldt
	 */

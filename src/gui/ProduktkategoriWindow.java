...
public class ProduktkategoriWindow extends Stage {
	...
	/*
	 * Aabner for vinduet "OpretKategoriWindow",hvorefter den tager alle objekter
	...
	/*
	 * Sletter det produktkategori man har klikket på fra listviewet, hvorefter den
	 * tager alle objekter fra InitAllProdukter og tilfoejer dem til Produktkategori
	 * Listviewet
	 *
	 */
	...
	/*
	 * Aabner for vinduet "GaaTilWindow", så længe man har klikket på en
	 * produktkategori fra listviewet
	 */
